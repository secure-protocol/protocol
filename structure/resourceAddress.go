...
type ResourceAddress struct {
	gorm.Model
	Address string `json:"address,omitempty" gorm:"type:varchar(255);comment:地址,raw 地址"`
	...
	NetworkKey string `json:"networkKey,omitempty" gorm:"type:varchar(255);comment:TRON  ETH  BSC  TRON-SHASTA"`
