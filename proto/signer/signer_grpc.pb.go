...
func (c *signerClient) BatchSign(ctx context.Context, in *BatchSignReq, opts ...grpc.CallOption) (*BatchSignRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchSignRes)
...
func _Signer_BatchSign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SignerServer).BatchSign(ctx, req.(*BatchSignReq))
	}
	return interceptor(ctx, in, info, handler)
}
